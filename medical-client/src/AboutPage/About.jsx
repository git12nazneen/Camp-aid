    ...
    <div className="container px-6 py-10 mx-auto">
        <div className="lg:flex lg:items-center">
            <div className="w-full space-y-12 lg:w-1/2 ">
                <div>
                    <h1 className="text-2xl font-semibold text-gray-800 capitalize lg:text-3xl dark:text-white">explore  <br/>And know us</h1>
                ...
                <div className="md:flex md:items-start md:-mx-4">
                    ...
                    <div className="mt-4 md:mx-4 md:mt-0">
                        <h1 className="text-xl font-semibold text-gray-700 capitalize dark:text-white">     Diagnostics:</h1>

                        <p className="mt-3 text-gray-500 dark:text-gray-300">
                        Blood tests, urine tests, and other diagnostic services to detect underlying health issues.
                        </p>
                    </div>
                </div>
                ...
                <div className="md:flex md:items-start md:-mx-4">
                    ...
                    <div className="mt-4 md:mx-4 md:mt-0">
                        <h1 className="text-xl font-semibold text-gray-700 capitalize dark:text-white">Specialist Consultations: </h1>

                        <p className="mt-3 text-gray-500 dark:text-gray-300">
                        Access to specialists in areas such as pediatrics, gynecology, cardiology, and dermatology.
                        </p>
                    </div>
                </div>
                ...
                <div className="md:flex md:items-start md:-mx-4">
                    ...
                    <div className="mt-4 md:mx-4 md:mt-0">
                        <h1 className="text-xl font-semibold text-gray-700 capitalize dark:text-white">Health Education</h1>

                        <p className="mt-3 text-gray-500 dark:text-gray-300">
                        Workshops and informational sessions on topics like family planning, disease prevention, and nutrition.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div className="hidden lg:flex lg:items-center lg:w-1/2 lg:justify-center">
                <img className="w-[28rem] h-[28rem] object-cover xl:w-[34rem] xl:h-[34rem] rounded-full" src={about} alt=""/>
            </div>
        </div>
