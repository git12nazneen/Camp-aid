...
const Blog = () => {
    return (
        <div>
            <section class="max-w-6xl mx-auto  bg-white dark:bg-gray-900">
        ...
        <div class="grid grid-cols-1 gap-8 mt-8 md:mt-16 md:grid-cols-2">
            <div class="lg:flex">
                ...
                <div class="flex flex-col justify-between py-6 lg:mx-6">
                    ...
                    Limited availability of medical supplies, equipment, and medications.
                    </a>
            ...
            <div class="lg:flex">
                ...
                <div class="flex flex-col justify-between py-6 lg:mx-6">
                    <a href="#" class="text-xl font-semibold text-gray-800 hover:underline dark:text-white ">
                    Challenges in transporting medical teams and supplies to remote areas.
                    </a>
            ...
            <div class="lg:flex">
                ...
                <div class="flex flex-col justify-between py-6 lg:mx-6">
                    <a href="#" class="text-xl font-semibold text-gray-800 hover:underline dark:text-white ">
                    Overcoming cultural beliefs and practices that may hinder participation.
                    </a>
            ...
            <div class="lg:flex">
                ...
                <div class="flex flex-col justify-between py-6 lg:mx-6">
                    <a href="#" class="text-xl font-semibold text-gray-800 hover:underline dark:text-white ">
                    Ensuring continuity of care and follow-up after the camp concludes.
                    </a>
            ...
            <div class="lg:flex">
                ...
                <div class="flex flex-col justify-between py-6 lg:mx-6">
                    <a href="#" class="text-xl font-semibold text-gray-800 hover:underline dark:text-white ">
                    Increased awareness about health issues and preventive measures.
                    </a>
            ...
            <div class="lg:flex">
                ...
                <div class="flex flex-col justify-between py-6 lg:mx-6">
                    <a href="#" class="text-xl font-semibold text-gray-800 hover:underline dark:text-white ">
                    Securing adequate funding and resources for organizing and maintaining the camps.
                    </a>
