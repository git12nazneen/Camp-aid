...
const AddCampFrom = ({
  ...
  return (
    <div className='w-full p-5 lg:p-10 min-h-[calc(100vh-40px)] flex flex-col justify-center items-center text-gray-800 rounded-xl bg-gray-50'>
      ...
      <div className='grid grid-cols-1 lg:grid-cols-2 gap-6'>
        ...
        <div className='space-y-6'>
          ...
          <div className='space-y-1 text-sm'>
            ...
            <textarea
              id='description'
              className='block w-full h-32 px-4 py-3 text-gray-800 border border-blue-300 focus:outline-blue-500 rounded-md'
              name='description'
            ></textarea>
          </div>
        </div>
