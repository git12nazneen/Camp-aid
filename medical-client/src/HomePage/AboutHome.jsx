...
const AboutHome = () => {
  return (
    <div className=" max-w-6xl mx-auto lg:pb-32 pb-2 md:pb-1">
          ...
          <div className="grid grid-cols-1 gap-8 mt-8 xl:mt-12 xl:gap-16 md:grid-cols-3 xl:grid-cols-3">
            ...
            <div className="flip-card ">
              <div className="flip-card-inner">
                <div className="flip-card-front flex flex-col items-center p-6 space-y-3 text-center bg-gray-100 rounded-xl">
                ...
                <div className="flip-card-back flex flex-col items-center p-6 space-y-3 text-center bg-gray-100 rounded-xl">
                  <span className="inline-block p-3 text-blue-500 bg-blue-100 rounded-full dark:text-white">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className="w-6 h-6"
