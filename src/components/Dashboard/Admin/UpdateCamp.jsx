...
//             console.log(data);
//             const menuRes = await axiosSecure.patch(`/camps/${items._id}`, data);
...
//                         <div>
//                             <label className="text-gray-700 dark:text-gray-200" htmlFor="name">Camp name</label>
//                             <input
//                                 id="name"
//                                 type="text"
...
//                             />
//                             {errors.name && <span className="text-red-500">Camp name is required</span>}
//                         </div>
